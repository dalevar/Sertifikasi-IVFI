...
(function (global, factory) {
    ...
    /*
                      ...
                      */
    var createAnimator = function createAnimator(
        definition,
        category,
        property
    ) {
    ...
    var createView =
        ...
        function createView() {
            var _ref =
                ...
                destroy =
                    _ref$destroy === void 0 ? function () {} : _ref$destroy,
                ...
                didCreateView =
                    _ref$didCreateView === void 0
                        ? function () {}
                        : _ref$didCreateView,
                _ref$didWriteView = _ref.didWriteView,
                didWriteView =
                    _ref$didWriteView === void 0
                        ? function () {}
                        : _ref$didWriteView,
                _ref$ignoreRect = _ref.ignoreRect,
                ignoreRect =
                    _ref$ignoreRect === void 0 ? false : _ref$ignoreRect,
                _ref$ignoreRectUpdate = _ref.ignoreRectUpdate,
                ignoreRectUpdate =
                    _ref$ignoreRectUpdate === void 0
                        ? false
            ...
            return function (
                ...
                var internalAPIDefinition = Object.assign(
                    {},
                    sharedAPIDefinition,
                    {
                        rect: {
                        ...
                        registerDestroyer: function registerDestroyer(
                            destroyer
                        ) {
                ...
                // mixin API methods
                var mixinAPIDefinition = Object.assign(
                    {},
                    sharedAPIDefinition,
                    {
                        rect: {
    ...
    var createOptionQueries = function createOptionQueries(options) {
        return function (state) {
            var obj = {};
            forin(options, function (key) {
                obj["GET_" + fromCamels(key, "_").toUpperCase()] = function (
                    action
                ) {
    ...
    var extendDefaultOptions = function extendDefaultOptions(
        additionalOptions
    ) {
    ...
    var defaultOptions = {
        ...
        labelIdle: [
            'Seret & Lepaskan file Anda atau <span class="filepond--label-action">Pilih</span>',
            Type.STRING,
        ],
    ...
    var getNumericAspectRatioFromString =
        function getNumericAspectRatioFromString(aspectRatio) {
    ...
    var queries = function queries(state) {
        return {
            ...
            GET_PANEL_ASPECT_RATIO: function GET_PANEL_ASPECT_RATIO() {
                var isShapeCircle = /circle/.test(
                    state.options.stylePanelLayout
                );
            ...
            GET_ITEM_PANEL_ASPECT_RATIO:
                function GET_ITEM_PANEL_ASPECT_RATIO() {
            ...
            GET_FILE_SIZE_LABELS: function GET_FILE_SIZE_LABELS(query) {
                return {
                    ...
                    labelKilobytes:
                        query("GET_LABEL_FILE_SIZE_KILOBYTES") || undefined,
                    labelMegabytes:
                        query("GET_LABEL_FILE_SIZE_MEGABYTES") || undefined,
                    labelGigabytes:
                        query("GET_LABEL_FILE_SIZE_GIGABYTES") || undefined,
                };
            },
        };
    };
    ...
    var getBlobFromByteStringWithMimeType =
        function getBlobFromByteStringWithMimeType(byteString, mimeType) {
    ...
    var getBase64DataFromBase64DataURI =
        function getBase64DataFromBase64DataURI(dataURI) {
    ...
    var getByteStringFromBase64DataURI =
        function getByteStringFromBase64DataURI(dataURI) {
    ...
    var createFetchFunction = function createFetchFunction() {
        ...
        return function (url, load, error, progress, abort, headers) {
            ...
            request.onload = function (xhr) {
                ...
                // get filename
                var filename =
                    getFileInfoFromHeaders(headers).name ||
    ...
    var createFileProcessorFunction = function createFileProcessorFunction(
        ...
        return function (
            ...
            var shouldChunkUpload =
                canChunkUpload && file.size > options.chunkSize;
            var willChunkUpload =
    ...
    var createPerceivedPerformanceUpdater =
        function createPerceivedPerformanceUpdater(cb) {
            var duration =
                arguments.length > 1 && arguments[1] !== undefined
                    ? arguments[1]
                    : 1000;
    ...
    var createFileProcessor = function createFileProcessor(processFn, options) {
        ...
        var process = function process(file, metadata) {
            ...
            state.perceivedPerformanceUpdater =
            ...
            state.request = processFn(
                ...
                function () {
                    ...
                    api.fire(
                        "abort",
                        state.response ? state.response.body : null
                    );
                },
    ...
    var getFilenameWithoutExtension = function getFilenameWithoutExtension(
        name
    ) {
    ...
    var isFile = function isFile(value) {
        return !!(
            ...
            (value instanceof Blob && value.name)
        );
    };
    ...
    var createItem = function createItem() {
        ...
        var abortProcessing = function abortProcessing() {
            return new Promise(function (resolve) {
                ...
                abortProcessingRequestComplete =
                    function abortProcessingRequestComplete() {
                        resolve();
                    };
    ...
    var getItemByQueryFromState = function getItemByQueryFromState(
        ...
        return function () {
            ...
            var query = _ref.query,
                ...
                failure =
                    _ref$failure === void 0 ? function () {} : _ref$failure,
        ...
        return {
            ...
            MOVE_ITEM: function MOVE_ITEM(_ref4) {
                ...
                state.items.splice(
                    index,
                    0,
                    state.items.splice(currentIndex, 1)[0]
                );
            },
            ...
            ADD_ITEMS: function ADD_ITEMS(_ref6) {
                var items = _ref6.items,
                    ...
                    success =
                        _ref6$success === void 0
                            ? function () {}
                            : _ref6$success,
                    _ref6$failure = _ref6.failure,
                    failure =
                        _ref6$failure === void 0
                            ? function () {}
                            : _ref6$failure;
            ...
            ADD_ITEM: function ADD_ITEM(_ref7) {
                var source = _ref7.source,
                    ...
                    success =
                        _ref7$success === void 0
                            ? function () {}
                            : _ref7$success,
                    _ref7$failure = _ref7.failure,
                    failure =
                        _ref7$failure === void 0
                            ? function () {}
                            : _ref7$failure,
                ...
                if (
                    isFile(source) &&
                    state.options.ignoredFiles.includes(
                ...
                item.on("load-request-error", function (error) {
                    var mainStatus = dynamicLabel(
                        state.options.labelFileLoadError
                    )(error);
                ...
                item.on("process-error", function (error) {
                    dispatch("DID_THROW_ITEM_PROCESSING_ERROR", {
                        ...
                        status: {
                            main: dynamicLabel(
                                state.options.labelFileProcessingError
                            )(error),
                            sub: state.options.labelTapToRetry,
                        },
                    });
                ...
                item.on("process-revert-error", function (error) {
                    dispatch("DID_THROW_ITEM_PROCESSING_REVERT_ERROR", {
                        ...
                        status: {
                            main: dynamicLabel(
                                state.options.labelFileProcessingRevertError
                            )(error),
                            sub: state.options.labelTapToRetry,
                        },
                    });
            ...
            COMPLETE_LOAD_ITEM: function COMPLETE_LOAD_ITEM(_ref10) {
                ...
                dispatch("DID_LOAD_ITEM", {
                    ...
                    error: null,
                    serverFileReference:
                        item.origin === FileOrigin.INPUT ? null : source,
                });
            ...
            REQUEST_ITEM_PREPARE: getItemByQueryFromState(
                state,
                function (item, _success, failure) {
                    dispatch(
                        "REQUEST_PREPARE_OUTPUT",
                        {
                            query: item.id,
            ...
            RETRY_ITEM_PROCESSING: getItemByQueryFromState(
                state,
                function (item) {
            ...
            REQUEST_REMOVE_ITEM: getItemByQueryFromState(
                state,
                function (item) {
                    optionalPromise(
            ...
            REMOVE_ITEM: getItemByQueryFromState(
                state,
                function (item, success, failure, options) {
                        ...
                        server.remove(
                            ...
                            function (status) {
                                dispatch("DID_THROW_ITEM_REMOVE_ERROR", {
                                    ...
                                    status: {
                                        main: dynamicLabel(
                                            state.options.labelFileRemoveError
                                        )(status),
                                        sub: state.options.labelTapToRetry,
                                    },
                                });
            ...
            ABORT_ITEM_PROCESSING: getItemByQueryFromState(
                state,
                function (item) {
            ...
            REVERT_ITEM_PROCESSING: getItemByQueryFromState(
                ...
                function (item) {
                    item.revert(
                        ...
                        .then(function () {
                            var shouldRemove =
                                state.options.instantUpload || isMockItem(item);
                            if (shouldRemove) {
                                dispatch("REMOVE_ITEM", { query: item.id });
                            }
                        })
            ...
            SET_OPTIONS: function SET_OPTIONS(_ref11) {
                ...
                var prioritizedOptionKeys = PrioritizedOptions.filter(function (
                    key
                ) {
    ...
    var toNaturalFileSize = function toNaturalFileSize(bytes) {
        ...
        var _options$labelBytes = options.labelBytes,
            labelBytes =
                _options$labelBytes === void 0 ? "bytes" : _options$labelBytes,
            _options$labelKilobyt = options.labelKilobytes,
            labelKilobytes =
                _options$labelKilobyt === void 0 ? "KB" : _options$labelKilobyt,
            _options$labelMegabyt = options.labelMegabytes,
            labelMegabytes =
                _options$labelMegabyt === void 0 ? "MB" : _options$labelMegabyt,
            _options$labelGigabyt = options.labelGigabytes,
            labelGigabytes =
                _options$labelGigabyt === void 0 ? "GB" : _options$labelGigabyt;
        ...
        if (bytes < GB) {
            return (
                removeDecimalsWhenZero(bytes / MB, 1, decimalSeparator) +
                " " +
                labelMegabytes
            );
        }
        ...
        // gigabytes
        return (
            removeDecimalsWhenZero(bytes / GB, 2, decimalSeparator) +
            " " +
            labelGigabytes
        );
    };
    ...
    var updateFileSizeOnError = function updateFileSizeOnError(_ref3) {
        ...
        text(
            root.ref.fileSize,
            root.query("GET_LABEL_FILE_SIZE_NOT_AVAILABLE")
        );
    };
    ...
    var calculateFileVerticalCenterOffset =
        function calculateFileVerticalCenterOffset(root) {
            return Math.floor(
                root.ref.buttonRemoveItem.rect.element.height / 4
            );
        };
    var calculateFileHorizontalCenterOffset =
        function calculateFileHorizontalCenterOffset(root) {
    ...
    var route = createRoute({
        DID_SET_LABEL_BUTTON_ABORT_ITEM_PROCESSING:
            function DID_SET_LABEL_BUTTON_ABORT_ITEM_PROCESSING(_ref5) {
                var root = _ref5.root,
                    action = _ref5.action;
                root.ref.buttonAbortItemProcessing.label = action.value;
            },
        DID_SET_LABEL_BUTTON_ABORT_ITEM_LOAD:
            function DID_SET_LABEL_BUTTON_ABORT_ITEM_LOAD(_ref6) {
                var root = _ref6.root,
                    action = _ref6.action;
                root.ref.buttonAbortItemLoad.label = action.value;
            },
        DID_SET_LABEL_BUTTON_ABORT_ITEM_REMOVAL:
            function DID_SET_LABEL_BUTTON_ABORT_ITEM_REMOVAL(_ref7) {
                var root = _ref7.root,
                    action = _ref7.action;
                root.ref.buttonAbortItemRemoval.label = action.value;
            },
        DID_REQUEST_ITEM_PROCESSING: function DID_REQUEST_ITEM_PROCESSING(
            _ref8
        ) {
            var root = _ref8.root;
        ...
        DID_UPDATE_ITEM_PROCESS_PROGRESS:
            function DID_UPDATE_ITEM_PROCESS_PROGRESS(_ref12) {
    ...
    var write$3 = function write(_ref2) {
        ...
        if (
            root.ref.scalable === null ||
            props.scalable !== root.ref.scalable
        ) {
        ...
        var grab = function grab(e) {
            ...
            var drop = function drop(e) {
                ...
                if (removedActivateListener) {
                    setTimeout(function () {
                        return root.element.addEventListener(
                            "click",
                            root.ref.handleClick
                        );
                    }, 0);
    ...
    var write$4 = createRoute(
        ...
        function (_ref6) {
            ...
            if (!aspectRatio) {
                ...
                if (
                    !root.height &&
                    root.ref.container.rect.element.height > 0
                ) {
    ...
    var syncFieldPositionsWithItems = function syncFieldPositionsWithItems(
        root
    ) {
    ...
    var didAddItem = function didAddItem(_ref3) {
        ...
        var shouldUseFileInput =
            !isLocalFile && root.query("SHOULD_UPDATE_FILE_INPUT");
    ...
    var itemError = function itemError(_ref6) {
        ...
        assist(
            root,
            action.status.main + " " + filename + " " + action.status.sub
        );
    };
    ...
    var calculateListHeight = function calculateListHeight(root) {
        ...
        var newItem =
            typeof dragIndex !== "undefined" && dragIndex >= 0 ? 1 : 0;
    ...
    var calculateRootBoundingBoxHeight =
        function calculateRootBoundingBoxHeight(root) {
